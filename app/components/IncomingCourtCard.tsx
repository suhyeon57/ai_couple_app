...
export default function IncomingCourtCard({
  ...
  return (
    <div className="text-2xl text-center flex flex-col items-center justify-center gap-10 p-4">
      <div className="rounded-xl border p-5 shadow-md bg-white w-[500px]">
        ...
        <div className="mt-5 flex gap-3">
          <button
            onClick={onAccept}
            className="flex-1 rounded bg-blue-400 py-2 text-white"
          >
            수락
          </button>
          ...
          <button
            onClick={onReject}
            className="flex-1 rounded bg-red-400 py-2 text-white"
          >
            거절
          </button>
        </div>
